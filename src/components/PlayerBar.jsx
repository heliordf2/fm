  ...
  return (
    <footer ref={setPlayerBarEl} className="player-bar" style={{ '--radio-color': radio.color }}>
      <div className="player-bar__inner">
        ...
        <div className="player-bar__ticker" aria-live="polite">
          <div className="player-bar__ticker-track">
            <span className="player-bar__ticker-text">{tickerText}</span>
            <span className="player-bar__ticker-text" aria-hidden="true">
              {tickerText}
            </span>
          </div>
        </div>
