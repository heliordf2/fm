  ...
  return (
    <footer className="app__footer">
      <div className="app__footer-brand">
        ...
        <a className="app__whatsapp" href="https://wa.me/5511974004755?text=Ol%C3%A1%2C%20preciso%20de%20suporte%20sobre%20o%20R%C3%A1dio%20FM%20Online." target="_blank" rel="noopener noreferrer" aria-label="Fale conosco pelo WhatsApp no número +55 11 97400-4755">
