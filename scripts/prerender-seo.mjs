...
import { getAllRadios, getIndexableCities, getRadioMetaDescription, getRadioPageTitle, getRadiosByCity, getRadiosByGenre, getRelatedRadios, slugify } from '../src/data/radioRepository.js'
...
const directRoutes = radios.map((radio) => {
  ...
  return { path, title: getRadioPageTitle(radio), description, content, schemas: [organization, website, { '@type': 'WebPage', url: `${SITE}${path}`, name: radio.name, isPartOf: { '@id': `${SITE}/#website` } }, breadcrumb(radio.name, path), schema] }
})
